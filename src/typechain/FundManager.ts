...
export interface FundManagerInterface extends utils.Interface {
  functions: {
    ...
    "TRUSTED_CONTRACT_ROLE()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "TRUSTED_CONTRACT_ROLE",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export interface FundManager extends BaseContract {
  ...
  functions: {
    ...
    TRUSTED_CONTRACT_ROLE(overrides?: CallOverrides): Promise<[string]>;
  ...
  estimateGas: {
    ...
    TRUSTED_CONTRACT_ROLE(overrides?: CallOverrides): Promise<BigNumber>;
