    ...
    <section className="relative flex aspect-video flex-col items-center justify-center bg-[url('/images/illustrations/farmland.png')] bg-cover bg-fixed bg-top">
      ...
      <div className="p-page relative z-1 flex flex-col items-center gap-y-3 text-center text-white drop-shadow-lg">
        ...
        <h4 className="">
          ...
          we aim to revolutionize the insurance industry and empower farmers to
          protect their livelihoods effectively. By simplifying the insurance
        ...
        <h5 className="">
          ...
          blockchain's immutability, we ensure transparency and trust throughout
          the insurance journey, while our strategic collaborations with
          agricultural experts and stakeholders drive ongoing innovation and
          improvement. With our transformative approach to agricultural
          insurance, we aim to provide farmers with the confidence and financial
          stability necessary to make informed decisions, invest in their
          operations, and thrive in an ever-changing world. Together, we can
